...
#                     common_prefix = label[:common_length]
...
#         Returns:
#         - bool: True if the word exists in the Radix Tree, else False.
#         """
...
#         """
#         Checks if there is any word in the Radix Tree that starts with the given prefix.
...
class Trie:
    ...
    def traverse_prefix(self, word):
        ...
        return node.disklocstart, node.disklocend
